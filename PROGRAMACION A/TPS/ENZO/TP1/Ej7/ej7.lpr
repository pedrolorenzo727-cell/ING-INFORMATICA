...
begin
  ...
  writeln('H: ',
                (*Mazo Rojo tiene mas peso que Mazo Azul*)
                ((color1 = 'Rojo') and (color2 = 'Azul')) or

                (*Mazos iguales, palos iguales, comparo numeros*)
                (((color1 = 'Rojo') and (color2 = 'Rojo')) and (palo1 = palo2) and (nCarta1 > nCarta2)) or

                (*Mazos iguales, comparo todas las posibilidades de palos (O el mas alto y B el mas bajo). Ej: Palo1 = 0, palo2 deberia ser solo distinto a 0 y ya seria menor que palo 1*)
